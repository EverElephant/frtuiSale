...
(function (f, g, k) {
    ...
    var l = {
        ...
        addCssSpeed: function (a) {
            ...
            //console.log(d.newPosX)
            //�޸�
            if(a<-1920){
                return {
                    "-webkit-transform": "translate3d(" + -1920 + "px, 0px, 0px)",
                    "-moz-transform": "translate3d(" + -1920 + "px, 0px, 0px)",
                    "-o-transform": "translate3d(" + -1920 + "px, 0px, 0px)",
            ...
            //�޸�
            this.$owlWrapper.css(this.doTranslate(hhhhhhh))
        }, css2move: function (a) {
